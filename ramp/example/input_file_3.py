...
HH_lunch2_meat = HH.add_appliance(1, 1200, 2, 7, 0.15, 3, thermal_P_var=0.2, pref_index=2)
...
HH_lunch3_meat = HH.add_appliance(1, 1200, 2, 10, 0.2, 5, thermal_P_var=0.2, pref_index=3)
