...
HH_lunch2_egg = HH.add_appliance(
    1, 1200, 2, 3, 0.2, 3, thermal_p_var=0.2, pref_index=2, name="lunch2_egg"
)
...
HH_lunch2_meat = HH.add_appliance(
    1, 1200, 2, 7, 0.15, 3, thermal_p_var=0.2, pref_index=2, name="lunch2_meat"
)
...
HH_lunch3_meat = HH.add_appliance(
    1, 1200, 2, 10, 0.2, 5, thermal_p_var=0.2, pref_index=3, name="lunch3_meat"
)
...
HH_breakfast_coffee = HH.add_appliance(
    ...
    thermal_p_var=0.2,
    pref_index=0,
    name="break_fast_coffee",
)
HH_breakfast_coffee.windows([6 * 60, 9 * 60], [0, 0], 0.15)

HH_mate = HH.add_appliance(
    1, 1800, 1, 30, 0.3, 2, thermal_p_var=0.2, pref_index=0, name="mate"
)
