...
LMI = User("lower middle income",28)
User_list.append(LMI)

LI = User("low income",36)
User_list.append(LI)
...
HI_indoor_bulb.windows([1105,1440],[0,30],0.35)

HI_outdoor_bulb = HI.Appliance(HI,2,13,2,600,0.2,10)
HI_outdoor_bulb.windows([0,330],[1105,1440],0.35)

HI_TV = HI.Appliance(HI,2,60,3,180,0.1,5)
HI_TV.windows([720,900],[1105,1440],0.35,[0,60])

HI_DVD = HI.Appliance(HI,1,8,3,60,0.1,5)
HI_DVD.windows([720,900],[1105,1440],0.35,[0,60])

HI_Antenna = HI.Appliance(HI,1,8,3,120,0.1,5)
HI_Antenna.windows([720,900],[1105,1440],0.35,[0,60])
...
HI_Freezer.cycle_behaviour([580,1080],[0,0],[300,579],[0,0],[0,299],[1081,1440])
...
HI_Freezer2.cycle_behaviour([580,1080],[0,0],[300,579],[0,0],[0,299],[1081,1440])
...
HMI_indoor_bulb.windows([1105,1440],[0,30],0.35)

HMI_outdoor_bulb = HMI.Appliance(HMI,2,13,2,600,0.2,10)
HMI_outdoor_bulb.windows([0,330],[1105,1440],0.35)

HMI_TV = HMI.Appliance(HMI,1,60,2,120,0.1,5)
HMI_TV.windows([1105,1440],[0,60],0.35)

HMI_DVD = HMI.Appliance(HMI,1,8,2,40,0.1,5)
HMI_DVD.windows([1105,1440],[0,60],0.35)

HMI_Antenna = HMI.Appliance(HMI,1,8,2,80,0.1,5)
HMI_Antenna.windows([1105,1440],[0,60],0.35)
...
HMI_Freezer.cycle_behaviour([580,1080],[0,0],[300,579],[0,0],[0,299],[1081,1440])
...
LMI_indoor_bulb.windows([1105,1440],[0,30],0.35)

LMI_outdoor_bulb = LMI.Appliance(LMI,2,13,2,600,0.2,10)
LMI_outdoor_bulb.windows([0,330],[1105,1440],0.35)

LMI_TV = LMI.Appliance(LMI,1,60,3,90,0.1,5)
LMI_TV.windows([450,660],[1105,1440],0.35)

LMI_DVD = LMI.Appliance(LMI,1,8,3,30,0.1,5)
LMI_DVD.windows([450,660],[1105,1440],0.35)

LMI_Antenna = LMI.Appliance(LMI,1,8,3,60,0.1,5)
LMI_Antenna.windows([450,660],[1105,1440],0.35)
...
LI_indoor_bulb.windows([1105,1440],[0,30],0.35)

LI_outdoor_bulb = LI.Appliance(LI,1,13,2,600,0.2,10)
LI_outdoor_bulb.windows([0,330],[1105,1440],0.35)

LI_TV = LI.Appliance(LI,1,60,3,90,0.1,5)
LI_TV.windows([750,840],[1105,1440],0.35,[0,30])

LI_DVD = LI.Appliance(LI,1,8,3,30,0.1,5)
LI_DVD.windows([750,840],[1105,1440],0.35,[0,30])

LI_Antenna = LI.Appliance(LI,1,8,3,60,0.1,5)
LI_Antenna.windows([750,840],[1105,1440],0.35,[0,30])
