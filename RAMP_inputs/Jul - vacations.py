...
HI_indoor_bulb.windows([1074,1440],[0,30],0.35)

HI_outdoor_bulb = HI.Appliance(HI,2,13,2,600,0.2,10)
HI_outdoor_bulb.windows([0,330],[1074,1440],0.35)

HI_TV = HI.Appliance(HI,2,60,3,180,0.1,5)
HI_TV.windows([720,900],[1074,1440],0.35,[0,60])

HI_DVD = HI.Appliance(HI,1,8,3,60,0.1,5)
HI_DVD.windows([720,900],[1074,1440],0.35,[0,60])

HI_Antenna = HI.Appliance(HI,1,8,3,120,0.1,5)
HI_Antenna.windows([720,900],[1074,1440],0.35,[0,60])

HI_Phone_charger = HI.Appliance(HI,5,2,2,300,0.2,5)
HI_Phone_charger.windows([1110,1440],[0,30],0.35)

HI_Freezer = HI.Appliance(HI,1,200,1,1440,0,30,'yes',2)
HI_Freezer.windows([0,1440],[0,0])
HI_Freezer.specific_cycle_1(5,15,200,15)
HI_Freezer.specific_cycle_2(5,20,200,10)
HI_Freezer.cycle_behaviour([480,1200],[0,0],[0,479],[1201,1440])

HI_Freezer2 = HI.Appliance(HI,1,200,1,1440,0,30,'yes',2)
HI_Freezer2.windows([0,1440],[0,0])
HI_Freezer2.specific_cycle_1(200,15,5,15)
HI_Freezer2.specific_cycle_2(5,20,200,10)
HI_Freezer2.cycle_behaviour([480,1200],[0,0],[0,479],[1201,1440])
...
HMI_indoor_bulb.windows([1074,1440],[0,30],0.35)

HMI_outdoor_bulb = HMI.Appliance(HMI,2,13,2,600,0.2,10)
HMI_outdoor_bulb.windows([0,330],[1074,1440],0.35)

HMI_TV = HMI.Appliance(HMI,1,60,2,120,0.1,5)
HMI_TV.windows([1074,1440],[0,60],0.35)

HMI_DVD = HMI.Appliance(HMI,1,8,2,40,0.1,5)
HMI_DVD.windows([1074,1440],[0,60],0.35)

HMI_Antenna = HMI.Appliance(HMI,1,8,2,80,0.1,5)
HMI_Antenna.windows([1074,1440],[0,60],0.35)

HMI_Radio = HMI.Appliance(HMI,1,36,2,60,0.1,5)
HMI_Radio.windows([390,450],[1074,1260],0.35)

HMI_Phone_charger = HMI.Appliance(HMI,4,2,2,300,0.2,5)
HMI_Phone_charger.windows([1110,1440],[0,30],0.35)

HMI_Freezer = HMI.Appliance(HMI,1,200,1,1440,0,30, 'yes',2)
HMI_Freezer.windows([0,1440],[0,0])
HMI_Freezer.specific_cycle_1(5,15,200,15)
HMI_Freezer.specific_cycle_2(200,10,5,20)
HMI_Freezer.cycle_behaviour([480,1200],[0,0],[0,479],[1201,1440])
...
LMI_indoor_bulb.windows([1074,1440],[0,30],0.35)

LMI_outdoor_bulb = LMI.Appliance(LMI,2,13,2,600,0.2,10)
LMI_outdoor_bulb.windows([0,330],[1074,1440],0.35)

LMI_TV = LMI.Appliance(LMI,1,60,3,90,0.1,5)
LMI_TV.windows([450,660],[1074,1440],0.35)

LMI_DVD = LMI.Appliance(LMI,1,8,3,30,0.1,5)
LMI_DVD.windows([450,660],[1074,1440],0.35)

LMI_Antenna = LMI.Appliance(LMI,1,8,3,60,0.1,5)
LMI_Antenna.windows([450,660],[1074,1440],0.35)
...
LI_indoor_bulb.windows([1074,1440],[0,30],0.35)

LI_outdoor_bulb = LI.Appliance(LI,1,13,2,600,0.2,10)
LI_outdoor_bulb.windows([0,330],[1074,1440],0.35)

LI_TV = LI.Appliance(LI,1,60,3,90,0.1,5)
LI_TV.windows([750,840],[1074,1440],0.35,[0,30])

LI_DVD = LI.Appliance(LI,1,8,3,30,0.1,5)
LI_DVD.windows([750,840],[1074,1440],0.35,[0,30])

LI_Antenna = LI.Appliance(LI,1,8,3,60,0.1,5)
LI_Antenna.windows([750,840],[1074,1440],0.35,[0,30])
...
Ho_Fridge = Hospital.Appliance(Hospital,1,150,1,1440,0,30, 'yes',2)
Ho_Fridge.windows([0,1440],[0,0])
Ho_Fridge.specific_cycle_1(5,15,150,15)
Ho_Fridge.specific_cycle_2(5,20,150,10)
Ho_Fridge.cycle_behaviour([480,1200],[0,0],[300,479],[1201,1440])

Ho_Fridge2 = Hospital.Appliance(Hospital,1,150,1,1440,0,30, 'yes',2)
Ho_Fridge2.windows([0,1440],[0,0])
Ho_Fridge2.specific_cycle_1(5,15,150,15)
Ho_Fridge2.specific_cycle_2(150,10,5,20)
Ho_Fridge2.cycle_behaviour([480,1200],[0,0],[0,479],[1201,1440])

Ho_Fridge3 = Hospital.Appliance(Hospital,1,150,1,1440,0.1,30, 'yes',2)
Ho_Fridge3.windows([0,1440],[0,0])
Ho_Fridge3.specific_cycle_1(150,15,5,15)
Ho_Fridge3.specific_cycle_2(5,20,150,10)
Ho_Fridge3.cycle_behaviour([480,1200],[0,0],[0,479],[1201,1440])
...
S_Freezer = School.Appliance(School,1,200,1,1440,0,30, 'yes',2)
S_Freezer.windows([0,1440])
S_Freezer.specific_cycle_1(200,15,5,15)
S_Freezer.specific_cycle_2(200,10,5,20)
S_Freezer.cycle_behaviour([480,1200],[0,0],[0,479],[1201,1440])
